...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  hostedDeviceLink: () => ipcRenderer.invoke('hosted-device-link'),
  hostedDevices: () => ipcRenderer.invoke('hosted-devices'),
  hostedDeviceRevoke: (deviceId) => ipcRenderer.invoke('hosted-device-revoke', deviceId),
